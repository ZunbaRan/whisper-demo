...
class TranscriptionService:
    ...
    async def transcribe_audio(self, audio_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            base_name = os.path.splitext(filename)[0]
            simplified_output_file = os.path.join("output", f"{base_name}.txt")
    ...
    async def process_single_file(self, entry: Dict[str, Any], file_path: str) -> Dict[str, bool]:
        ...
        try:
            ...
            simplified_output_file = result.get("simplified_output_file", "")
            # 把这个文件改为 id.txt
            os.rename(simplified_output_file, os.path.join("output", f"{entry_id}.txt"))
